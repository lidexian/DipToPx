...
public final class ArticleInfo extends com.duowan.taf.jce.JceStruct implements java.lang.Cloneable
{
    ...
    public ArticleInfo(long id, String title, java.util.ArrayList<String> imageList, java.util.ArrayList<String> videoList, String sourceName, int time, int commentCount, int articleType, String sourceUrl, String channelName, long flag, java.util.Map<Long, String> extraInfo)
    {
        setId(id);
        setTitle(title);
        setImageList(imageList);
    ...
    public void readFrom(com.duowan.taf.jce.JceInputStream _is)
    {
        ...
        if(null == cache_imageList)
        {
            ...
            String __var_6 = "";
            ((java.util.ArrayList<String>)cache_imageList).add(__var_6);
        }
        ...
        if(null == cache_videoList)
        {
            ...
            String __var_7 = "";
            ((java.util.ArrayList<String>)cache_videoList).add(__var_7);
        }
        ...
        if(null == cache_extraInfo)
        {
            ...
            Long __var_8 = 0L;
            String __var_9 = "";
            cache_extraInfo.put(__var_8, __var_9);
        }
